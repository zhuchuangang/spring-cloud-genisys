        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="${request.contextPath}/page"><i class="fa fa-circle-o"></i> ChartJS</a></li>
                        <li><a href="${request.contextPath}/page"><i class="fa fa-circle-o"></i> Morris</a></li>
                        <li><a href="${request.contextPath}/page"><i class="fa fa-circle-o"></i> Flot</a></li>
                        <li><a href="${request.contextPath}/page"><i class="fa fa-circle-o"></i> Inline charts</a></li>
                    </ul>
                </li>
                <#--<li class="treeview">-->
                    <#--<a href="#">-->
